 ...
 *
 * GEMELO de `src/lib/allergens.ts` en la web, que es donde se filtra de verdad
 * al autocompletar. Aquí se usa solo para ENSEÑAR la expansión en la
 * entrevista. Si se toca un grupo, tocarlo en los dos.
 */
