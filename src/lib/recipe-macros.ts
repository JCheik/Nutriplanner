 ...
 * catálogo compartido.
 *
 * Esta lógica estaba escrita TRES veces —la vista previa en vivo del editor,
 * `admin/verificar-recetas` y la app nativa—, y las tres tenían que dar el mismo
 * número para el mismo plato. Aquí vive la de la web; el espejo de la app está
 * en `native/src/lib/recipe-macros.ts` con los mismos nombres, para que se vea
 * de un vistazo que no se han separado.
 *
